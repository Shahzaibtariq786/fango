...
const Footer = () => {
  return (
    <footer id='footer' className="2xl:px-[var(--lg-scr-horizontal-space)] caret-transparent min-h-[110vh] min-md:min-h-[75vh] overflow-x-hidden min-xl:min-h-[120vh] w-full bg-top bg-no-repeat relative overflow-y-hidden bg-cover" style={{backgroundImage: `url(${FooterBg})`}}>
