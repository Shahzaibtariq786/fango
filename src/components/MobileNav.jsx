...
const MobileNav = (props)=>{
    return(
          <div id='mobile-menu' className='lg:hidden backdron-filter backdrop-blur-md z-[100] transition-all duration-500 ease-linear absolute bg-black/50 min-h-lvh top-0 left-0 w-full pt-[50%] sm:pt-[15%]'>
        <div className='w-full h-3/4 min-h-[30vh] flex flex-col items-center justify-around mb-6'>
        ...
        <div>
            <div className='space-x-5 h-1/4 w-full text-center'>
    ...
    <div className='text-light-green absolute lg:hidden bottom-[35%] whitespace-nowrap sm:bottom-[47%] font-bold uppercase z-10 left-1/2  xl:left-[55%] -translate-x-1/2'>Developed By Shahzaib Tariq 🤗</div>
        </div>
      </div>
    )
}
